...
export default function About() {
    ...
    const p4 = "My aim is to become a skilled full-stack developer — someone who not only builds software but creates solutions that make life a little simpler and smarter. To reach that goal, I’m constantly learning, experimenting with new technologies, and building projects that challenge my skills."
    ...
    return (
        <div className="relative">
            <div className="relative w-full min-h-screen flex items-center justify-center z-5 bg-[#FEFDF8]">
                <div className="mt-18 lg:mt-8 w-xs lg:w-xl flex flex-col items-center justify-center">
